...
<link rel="stylesheet"  href="http://localhost/php_project/bootstrap/bootstrap.min.css">
<link href="https://fonts.googleapis.com/css?family=Courgette" rel="stylesheet">
<script src="http://localhost/php_project/bootstrap/bootstrap.min.js"></script>
<style>
body{
...
<body>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://localhost/php_project/">Management System</a>
    </div>
     <div class="collapse navbar-collapse" id="nav">
    <ul class="nav navbar-nav">
      <li class="active"><a href="http://localhost/php_project">Home</a></li>
      <li><a href="http://localhost/php_project/studentform.php">Enter Student Data </a></li>
      <li><a href="http://localhost/php_project/nteacher.php">Enter Teacher Data </a></li>
      <li><a href="http://localhost/php_project/updatestudentdata.php">Update Student Data </a></li>
      <li><a href="http://localhost/php_project/updateteacherdata.php">Update Teacher Data </a></li>
    </ul>
  </div>
</div>
</nav>
...
<div class="col-xs-6">
 ...
 <select name="birth" class="form-control">
    ...
    <a href="http://localhost/php_project/updatestudentdata.php"<button class="btn btn-info btn-block btn-lg">Update | Delete | Find</button></a>
